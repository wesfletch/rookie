...
foreach(_cmake_expected_target IN ITEMS mobility_driver::mobility_driver_lib)
...
# Create imported target mobility_driver::mobility_driver_lib
add_library(mobility_driver::mobility_driver_lib STATIC IMPORTED)

set_target_properties(mobility_driver::mobility_driver_lib PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/mobility_driver"
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/export_mobility_driverExport-*.cmake")
